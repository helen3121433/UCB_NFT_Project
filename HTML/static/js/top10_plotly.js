...
const nft_url = [];
const pandas_url =
  "https://raw.githubusercontent.com/helen3121433/UCB_NFT_Project/xiaochen_z/json_js_plotly/top10_pandas.json";
const degenerate_url =
  "https://raw.githubusercontent.com/helen3121433/UCB_NFT_Project/xiaochen_z/json_js_plotly/top10_degenerate.json";
const geckos_url =
  "https://raw.githubusercontent.com/helen3121433/UCB_NFT_Project/xiaochen_z/json_js_plotly/top10_geckos.json";
const guildsaga_url =
  "https://raw.githubusercontent.com/helen3121433/UCB_NFT_Project/xiaochen_z/json_js_plotly/top10_guildsaga.json";
const magicticket_url =
  "https://raw.githubusercontent.com/helen3121433/UCB_NFT_Project/xiaochen_z/json_js_plotly/top10_magicticket.json";
const magnum_url =
  "https://raw.githubusercontent.com/helen3121433/UCB_NFT_Project/xiaochen_z/json_js_plotly/top10_magnum.json";
const monkelabs_url =
  "https://raw.githubusercontent.com/helen3121433/UCB_NFT_Project/xiaochen_z/json_js_plotly/top10_monkelabs.json";
...
function init() {
  ...
  colname.forEach((collection) => {
    selector.append("option").text(collection).property("value", collection);
  });
...
function buildCharts(collection, url) {
  d3.json(url).then(function (data) {
    ...
    var barLayout = {
      ...
      plot_bgcolor: "rgba(10,10,10,0.3)",
